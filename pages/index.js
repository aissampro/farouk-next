...
export default function Farouk() {
  ...
  const run = async () => {
    ...
    const finalOut = outResult || ""; console.log("OUT:", finalOut.length, finalOut.slice(0,100)); setOutputs(finalOut || "Generation complete - see Strategy tab for full analysis");
    setScreen('outputs')
